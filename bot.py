...
- напишите администратору: @ZabelloSergey

Чтобы помочь вам быстрее, сразу отправьте:
- что именно не получается,
- скриншот или короткое описание проблемы.

Если вопрос связан с оплатой или доступом к курсу, сразу укажите свой Telegram username.
""".strip()
